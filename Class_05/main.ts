...
let petts = ["cat","dog","cow","bull","horse"];
...
let pett = ["cat","dog","cow","bull","horse"];
...
let pts = ["cat","dog","cow","bull","horse"];
...
let petc = ["cat","dog","cow","bull","horse"];
...
let pet = ["cat","dog","cow","bull","horse"]
...
let pats = ["cat","dog","cow","bull","horse"];

let sliceArray = pats.slice(1);//["dog","cow","bull","horse"]
